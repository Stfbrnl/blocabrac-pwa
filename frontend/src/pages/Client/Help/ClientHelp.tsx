...
const sections: HelpSection[] = [
  {
    ...
    points: [
      ...
      'Choisissez d\'abord votre nombre d\'essais, puis indiquez « Réussi » ou « Échoué ». Il n\'y a pas de valeur par défaut : un bloc réussi du premier coup se déclare en choisissant « 1 essai ».',
  ...
  },
  {
    ...
    intro: 'Une grille de 8 missions calées sur votre niveau, sur « Mon Blocabrac quotidien ». Elle repart à zéro chaque lundi.',
    points: [
      'La plupart des cases se cochent toutes seules pendant que vous grimpez : un bloc de votre niveau max, 4 murs différents, un flash, un bloc en dévers, en rétablissement, en dalle.',
      'Le niveau des missions est figé pour toute la semaine : si vous progressez en cours de semaine, la grille suit le lundi suivant.',
      'Un flash, c\'est un bloc réussi au premier essai sans l\'avoir jamais tenté auparavant.',
  ...
  },
  {
    ...
    points: [
      ...
      '« J\'ai relevé le défi » enregistre le défi comme réussi et coche la mission Roulette de la semaine : le compteur s\'affiche sous les boutons Roulette et dans « Mes stats » (avec vos 10 derniers défis). Vous pouvez préciser le bloc utilisé (mur + numéro), c\'est facultatif. Cela ne compte pas comme une validation de bloc : classement, badges et niveau ne bougent pas.',
    ...
    <Container maxWidth="md">
      <Paper sx={{ p: { xs: 2, sm: 3 }, mt: 3, mb: 4 }}>
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
          ...
          Astuce : l'icône <em>lune/soleil</em> en haut de l'écran bascule entre thème clair et sombre, sur toutes les pages.
        </Typography>
